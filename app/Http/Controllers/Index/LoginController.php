...
class LoginController extends Controller
{
    ...
    public function SendByMobile($name,$code){
		...
		AlibabaCloud::accessKeyClient('LTAI4G37Y6EaV9ond5iJSYod', 'uRUBirpqwSd2Ges3RvwqNXdmPsFbuN')
	...
	public function proinfo($id){
		...
		$num=Cache::get('num_'.$id,1);
		$num=Cache::increment('num_'.$id,1);
		// $goods = Goods::find($id);
		// dd($goods);
